...
class ProfileRepository {
    ...
    fun getCurrentFirestoreUser() {
        if (currentUser != null) {
            val currentUserRef = FirestoreReferences.getCurrentUserRef(currentUser.uid)
    ...
    fun saveUserInFirestore(user: User) {
        val newUserRef = FirestoreReferences.getCurrentUserRef(user.id!!)
    ...
    fun updateFirestorePhoto(newPhoto: String) {
        val newUserRef = FirestoreReferences.getCurrentUserRef(currentUser?.uid!!)
